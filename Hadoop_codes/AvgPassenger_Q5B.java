...
public class AvgPassenger_Q5B {
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            ...
            if (!columns[0].trim().isEmpty()) {
                ...
                try {
                    ...
                    context.write(new Text(date.getHour() + "_Hour" + totalPassengerkey),
                            new DoubleWritable(Float.parseFloat(columns[4])));

                    context.write(new Text(date.getHour() + "_Hour" + totalTripKey), one);
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setJarByClass(AvgPassenger_Q5B.class);
